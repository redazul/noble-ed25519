...
async function getExtendedPublicKey(key) {
    ...
    console.log(await exports.utils.sha512(checkPrivateKey(key)));
    console.log(getKeyFromHash(await exports.utils.sha512(checkPrivateKey(key))));
...
function getExtendedPublicKeySync(key) {
    ...
    console.log(checkPrivateKey(key));
    console.log(exports.utils.sha512(checkPrivateKey(key)));
